...
def run_bi_spectral(word_vec_model, n_init = 1, max_iter = 300, tol = 1e-4, \
                    bisecting_strategy = "biggest_inertia"): 
    
    bi_spectral = SpectralBiclustering(n_clusters = len(Categories.get_values_as_list()), \
    ...
    model_details = {
        ...
        RESULT_CLUSTER_ALGO_KEY : ClusteringAlgorithms.SPECT_BI.value,
        "init" : "k-means++", 
        "n_init" : n_init, 
        "max_iter" : max_iter, 
        "tol" : tol, 
    ...
    run_clustering(word_vec_model, bi_spectral, model_details)
